        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
            	@if(!$errors-> has('matkhaucu') || !$errors-> has('matkhaumoi') || !$errors-> has('nhaplaimatkhau'))
                    ...
                    @endif
                @endif
                <form action="{{route('sv_bv_lv.postthem')}}" method="POST">
                    ...
                    <div class="form-group">
                        <label>Điểm</label>
                        <input class="form-control" name="diem" value="{{old('diem')}}" placeholder="Nhập điểm" />
                    </div>
...
@section('ajax')
    <script>
        $(document).ready(function() {
            ...
            //     var masv = $('#masv').val();
            //     $.get("admin/ajax/luanvan/"+masv, function(val){
            //         //alert(data);
            //         $('#malv').html(val);
            //     });
            // });
